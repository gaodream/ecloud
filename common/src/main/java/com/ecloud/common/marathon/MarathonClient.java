package com.ecloud.common.marathon;
...
public class MarathonClient {
	...
	public static volatile String  marathonUrl = "";
	 ...
	 * @return
	 */
	public static Pair<Integer,String> createAndStart(String marathonUrl, String json, 
			String marathonName,String marathonPass) {
		if (StringUtils.isEmpty(marathonName) || StringUtils.isEmpty(marathonPass)) {
			return HttpClient.doPost(marathonUrl + "/v2/apps", json);
		} else {
			return HttpClient.doPostWithAuth(marathonUrl + "/v2/apps", json, marathonName, marathonPass);
		}
	}
	/**
	 * 停止容器
	 ...
	 * @return
	 */
	public static Pair<Integer,String> destory(String marathonUrl, String marathonAppId, 
			String marathonName,String marathonPass) {
		if (StringUtils.isEmpty(marathonName) || StringUtils.isEmpty(marathonPass)) {
			return HttpClient.doDelete(marathonUrl + "/v2/apps/" + marathonAppId);
		} else {
			return HttpClient.doDeleteWithAuth(marathonUrl + "/v2/apps/" + marathonAppId, marathonName, marathonPass);
		}
	}
    ...
    public static Pair<Integer,String> registerEventSubscription(String marathonAddress,String marathonName,String marathonPass,String callback) {
          ...
          if(StringUtils.isEmpty(marathonName)||StringUtils.isEmpty(marathonPass)){
          	return HttpClient.doPost(buffer.toString(),"");
          }else{
    ...
    public static Integer getActiveTaskNumByAppId(String marathonAddress,String marathonName,String marathonPass,String appId) {
        // curl -X GET http://10.1.235.83:8080/v2/apps/{appId}/tasks -H Content-Type:application/json
